...
function Book(props: Props) {
  return (
    <div className="w-full md:grid md:grid-cols-2 md:gap-10 py-10">
      <div className="flex items-center mb-10 md:mb-0 justify-start relative">
        ...
        <Image
          className="z-10 w-2/3 mx-auto md:ml-20 -rotate-12"
          src={props.img}
          alt="book cover"
          width={300}
          height={500}
      ...
      <div className="md:text-end text-center space-y-10">
        ...
        <p className="text-muted text-3xl flex justify-center items-center md:hidden">
          Swap <ArrowLeftRight size={32} />{" "}
        </p>
      </div>
    </div>
  );
