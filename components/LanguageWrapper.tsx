  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', maxWidth: '600px' }}>
        <div>
          <h3 style={{ marginBottom: '10px', color: '#475569' }}>Basic Button</h3>
        ...
        <div>
          <h3 style={{ marginBottom: '10px', color: '#475569' }}>Multiple Buttons</h3>
        ...
        <div>
          <h3 style={{ marginBottom: '10px', color: '#475569' }}>English/Gujarati Only</h3>
          <LanguageToggleWrapper
            textKey="search"
            position="top-right"
          >
...
export type { LanguageToggleWrapperProps, LanguageCode, TranslationKey, PositionType };
