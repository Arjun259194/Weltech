...
export default function FeatureSection() {
  return (
    <section className="text-center py-10">
      ...
      <p className="mb-10">We provide comprehensive coaching designed to bring out
        <br />the <AccentUnderline className="text-2xl" underline>best in every student.</AccentUnderline>
      </p>
