  ...
  return (
    <section className="w-11/12 mx-auto h-screen">
      <div style={{
        ...
        <h1 className="text-6xl font-semibold ">Stop Translating.<br />Start Speaking</h1>
        <p className="w-[45ch] text-xl">Master Englisj conversation with expert traners and proven methods that deliver real results</p>
