...
export default function ReviewSection() {
  return (
    <section className=" bg-linear-to-b from-background to-primary  w-full mx-auto overflow-x-hidden space-y-5 py-10">
      <div className="md:w-11/12 mx-auto">
        ...
        <InfiniteMovingCards
          ...
          items={new Array(6).fill(0).map((_, i) => {
            return (
              <li
                className="relative w-100 h-150 md:w-md md:h-72 max-w-full shrink-0 rounded-2xl"
                key={i}
              >
                <ReviewCard
                  rating={3.5}
